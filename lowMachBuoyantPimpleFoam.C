...
Description
    Transient solver for buoyant, turbulent, low-Mach number flows.

    Turbulence is modelled using a run-time selectable variable-rho LES models.
...
int main(int argc, char *argv[])
{
	...
	// Reset density back to thermo.rho() after the cont err check
